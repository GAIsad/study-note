        ...
        for (let day = 1; day <= lastDay.getDate(); day++) {
            ...
            if (highlightDatesWithoutMaven.includes(currentDate)) {
                ...
                dayElement.addEventListener('click', () => {
                    ...
                    const url = `https://gitee.com/clay_2_0/ice1/tree/master/src/day${currentDate.toString().slice(2) }`;
            ...
            if (highlightDatesWithMaven.includes(currentDate)) {
                ...
                dayElement.addEventListener('click', () => {
                    let urlSuffix = currentDate.toString() >= specialDate ? '/note' : '';
                    const url = `https://gitee.com/clay_2_0/am_/tree/master/src/main/java/day${currentDate.toString().slice(2) }`;
                    window.open(url, '_blank');
                });
            }
            if (highlightDatesWeb1.includes(currentDate)) {
                ...
                dayElement.addEventListener('click', () => {
                    const url = `https://github.com/GAIsad/GAIsad.github.io`;
                    window.open(url, '_blank');
                });
            }
